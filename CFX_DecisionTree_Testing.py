...
Code Description: A python code to test the efficacy of CFX+Decision Tree on the Iris dataset.
...
CFX hyperparameters description:
_______________________________________________________________________________
...
ML hyperparameters description:
_______________________________________________________________________________
