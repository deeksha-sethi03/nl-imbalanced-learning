...
Code Description: A python code to tune the hyperparameters of CFX+AdaBoost on the Wine dataset.
...
k_cross_validation(FOLD_NO, X_train_norm, y_train, X_test_norm, y_test.ravel(), INITIAL_NEURAL_ACTIVITY, DISCRIMINATION_THRESHOLD, EPSILON)
