...
Code Description: A python code to tune the hyperparameters of ChaosNet on the Breast Cancer Wisconsin dataset.
...
DISCRIMINATION_THRESHOLD = np.arange(0.01, 0.99, 0.01)
